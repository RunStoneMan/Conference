...
namespace Registration.Handlers
{
        ...
        IEventHandler<SeatAssignmentUpdated>
    {
        ...
        {
            Mapper.Initialize(x => x.CreateMap<SeatAssigned, OrderSeat>());
            Mapper.Initialize(x => x.CreateMap<SeatAssignmentUpdated, OrderSeat>());
        ...
        {
            var dto =  this.storage.Find(GetSeatAssignmentsBlobId(id)).Result;
            if (dto == null)
                return null;
