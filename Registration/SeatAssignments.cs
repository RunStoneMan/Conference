...
namespace Registration
{
    ...
    public class SeatAssignments : EventSourced
    {
        ...
        {
            Mapper.Initialize(x=> x.CreateMap<SeatAssigned, SeatAssignment>());
            Mapper.Initialize(x => x.CreateMap<SeatUnassigned, SeatAssignment>());
            Mapper.Initialize(y=>y.CreateMap<SeatAssignmentUpdated, SeatAssignment>());
        }
